...
export const PET_ACTIVITY_EFFECT = 'dsh-tauri-pet: session activity'
...
export const PET_ACTIVITY_BUBBLE_MAX = 120
...
export const CMD_SET_PET_ACTIVITY = 'set_pet_activity'
export const CMD_SET_PET_SESSIONS = 'set_pet_sessions'
