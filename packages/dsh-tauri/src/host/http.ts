/**
 * host/http.ts — 宿主侧 HTTP 路由工具：连接鉴权包装、JSON 请求体读取、
...
import type { ConnectionGate, JsonBody, RouteFunction, RouteHandler } from './types.js'
import { Buffer } from 'node:buffer'

export type { ConnectionGate, JsonBody, RouteFunction, RouteHandler, RouteResult } from './types.js'
