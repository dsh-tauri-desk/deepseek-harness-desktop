...
pub fn handler() -> impl Fn(Invoke<Wry>) -> bool + Send + Sync + 'static {
    tauri::generate_handler![
        ...
        crate::bridge::rename_profile,
        crate::bridge::set_active_profile,
        crate::bridge::remove_profile,
        crate::bridge::get_profile_backups,
        crate::bridge::create_profile_backup,
        crate::bridge::restore_profile_backup,
        crate::bridge::delete_profile_backup,
        crate::bridge::get_profile_backup_settings,
        crate::bridge::update_profile_backup_settings,
